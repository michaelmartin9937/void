...
<Admonition variant="tip">Admonition `variant="tip"`</Admonition>

<Admonition variant="caution">Admonition `variant="caution"`</Admonition>

<Admonition variant="danger">Admonition `variant="danger"`</Admonition>

<Admonition variant="info">Admonition `variant="info"`</Admonition>
